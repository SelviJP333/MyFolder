...
let deletephaseid;
let deleteCompanyid;
const Approve_ViewTimesheet = ({route, navigation}) => {
    ...
    return (
      <SafeAreaView style={{flex: 1}}>
        ...
        <View style={styles.containerblue}>
          <View style={styles.headerApproved}>
            <Text style={styles.headerbluetext}>APPROVED</Text>
          </View>
        </View>
...
export default Approve_ViewTimesheet;
