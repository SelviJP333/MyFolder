...
const CopyEmployeeWarning = ({setCheckk, Checkk, text, navigation}) => {
        ...
        <Animated.View style={[styles.box, animatedStyles]}>
          <View style={styles.EmployeeContainer}>
            <View
              ...
              <View
                ...
                <View style={{marginLeft: 10}}>
                  <Image source={require('../Image/error.png')} />
                </View>
                <View>
                  <Text
                    style={{
            ...
            <Text style={{fontSize: 20, textAlign: 'left', left: 15, top: 25}}>
              No Entries found for employee to copy
            </Text>
            <View
              style={{
                top: '25%',
...
export default CopyEmployeeWarning;
